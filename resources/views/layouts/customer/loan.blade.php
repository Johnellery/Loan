                    ...
                    <form action="/create" method = "POST">
                        ...
                        <div class="border-b p-3 border-gray-900/10 pb-12">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-3">
                                    <input placeholder="Enter the Barangay" type="text" id="barangay" name="barangay"  autocomplete="barangay" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
