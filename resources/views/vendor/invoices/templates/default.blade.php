...
<html lang="en">
    ...
    <body>
        {{-- Header --}}
        @if($invoice->logo)
            <img src="{{ asset('storage/dashboardpage/logo.png') }}" alt="logo" height="100">
        @endif
                ...
                <tr>
                    <td class="border-0 pl-0" width="70%">
                        <h4 class="text-uppercase">
                            ...
                            <strong>{{ 'Bisikleta Bike Shop'}}</strong>
                        </h4>
                    </td>
            ...
            <thead>
                <tr>
                    ...
                    <th class="border-0 pl-0 party-header">
                        {{ __('Cashier / Authorized Representative') }}
                    </th>
                </tr>
            </thead>
            <tbody>
        ...
        <table class="table table-items">
            <thead>
                <tr>
                    <th scope="col" class="border-0 pl-0">{{ __('Bike name') }}</th>
                    @if($invoice->hasItemUnits)
                        <th scope="col" class="text-center border-0">{{ __('invoices::invoice.units') }}</th>
                    @endif
                    <th scope="col" class="text-center border-0">{{ __('Installment') }}</th>
                    <th scope="col" class="text-right border-0">{{ __('Installment') }}</th>
