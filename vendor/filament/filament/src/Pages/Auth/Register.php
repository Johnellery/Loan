...
class Register extends SimplePage
{
            ...
            'form' => $this->form(
                $this->makeForm()
                    ->schema([
                        ...
                        $this->getFirstFormComponent(),
                        $this->getMiddleFormComponent(),
                        $this->getLastFormComponent(),
    ...
    protected function getFirstFormComponent(): Component
    {
        return TextInput::make('first')
            ->label(__('filament-panels::pages/auth/register.form.name.label'))
            ->required()
    ...
    protected function getMiddleFormComponent(): Component
    {
        return TextInput::make('middle')
            ->label(__('filament-panels::pages/auth/register.form.name.label'))
            ->required()
    ...
    protected function getLastFormComponent(): Component
    {
        return TextInput::make('last')
            ->label(__('filament-panels::pages/auth/register.form.name.label'))
            ->required()
    ...
    protected function getPasswordConfirmationFormComponent(): Component
    {
        return TextInput::make('passwordConfirmation')
            ...
            ->required()
            ->helperText('Password must be 8 characters, with one uppercase.')
            ->dehydrated(false);
    }
    protected function getBranchFormComponent(): Component
    {
        return Select::make('branch_id')
            ->label(__('filament-panels::pages/auth/register.form.email.label'))
            ->options(function () {
                return Branch::all()->pluck('name', 'id');
            })
            ->label('Branch')
            ->native(false)
            ->required()
